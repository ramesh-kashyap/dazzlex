    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="#" class="brand-logo">
                <img src="{{asset('')}}main/images/crypto-logo.png" style="      width: 40px; " alt=""/>
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('admin.roi-bonus') }}">AD Cash Income
                            </a></li> 
                          
                            <li><a href="{{ route('admin.level-bonus') }}">Milestone income</a></li>
                              <li><a href="{{route('admin.booster-bonus')}}">Booster Income</a></li>
                        
                            <!--<li><a href="{{route('admin.club-bonus')}}">Company Reward</a></li>  -->
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('admin.add-price')}}">Add Ads</a></li>
                    
                            <li><a href="{{route('admin.taskReport')}}">Reports</a></li>
                        </ul>
                    </li>
           ...
           <li><a href="{{route('admin.add-wallet')}}" class="ai-icon" aria-expanded="false">
                <i class="flaticon-072-printer"></i>
