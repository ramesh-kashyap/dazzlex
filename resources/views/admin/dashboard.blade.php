						...
						<div class="row">
							...
							<div class="col-xl-3 col-sm-3">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Active Users</span>
							...
							<div class="col-xl-3 col-sm-3">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Company Users</span>
											<h2>{{\DB::table('company_users')->sum('member')}}</h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
							...
							<!--				<h2><span style="">$ </span> {{  number_format((\App\Models\Investment::where('status','Active')->sum('amount')),2)   }} </h2>-->
							<!--			</div>	-->
							<!--			<div class="d-inline-block position-relative donut-chart-sale">-->
       ...
       <!--                                         <img src="{{asset('admin/images/withdrawal.png')}}" style="    width: 61px;" alt="">-->
							...
							<div class="col-xl-3 col-sm-3">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">AD Cash Income											</span>
											<h2>{{currency()}} {{  number_format((\App\Models\Income::where('remarks','AD Cash Income')->sum('comm')),2)   }}  </h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
								...
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Milestone income</span>
											<h2>{{currency()}}  {{  number_format((\App\Models\Income::where('remarks','Milestone Income')->sum('comm')),2)   }}  </h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
                    	...
                    	<div class="col-xl-3 col-sm-3">
								<div class="card">
									<div class="card-body d-flex align-items-center justify-content-between">
										<div class="menu">
											<span class="font-w500 fs-16 d-block mb-2">Booster income</span>
											<h2>{{currency()}}  {{  number_format((\App\Models\Income::where('remarks','Booster Income')->sum('comm')),2)   }}  </h2>
										</div>	
										<div class="d-inline-block position-relative donut-chart-sale">
