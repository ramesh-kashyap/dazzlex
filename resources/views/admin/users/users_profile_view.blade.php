                                ...
                                {{ csrf_field() }}
                                   <div class="row">
                                       ...
                                       <div class="mb-3 col-md-12">
                                        ...
                                        <input type="text" value="{{($profile)?$profile->trx_addres:''}}" id="phoneNumber" name="usdtTrc20" class="form-control"
                                            placeholder="USDT TRC20" />
                                       </div> 
                                       
                                       <div class="mb-3 col-md-12">
                                        <label class="form-label">USDT BEP20</label>
                                        <input type="text" value="{{($profile)?$profile->usdBep20:''}}" id="phoneNumber" name="usdtBep20" class="form-control"
                                            placeholder="USDT BEP20" />
                                       </div>  
                                       
                                       <div class="mb-3 col-md-12">
                                        <label class="form-label">USDT Arbitrum</label>
                                        <input type="text" value="{{($profile)?$profile->usdArbitrum:''}}" id="phoneNumber" name="usdtArbitrum" class="form-control"
                                            placeholder="USDT Arbitrum" />
                                       </div>
