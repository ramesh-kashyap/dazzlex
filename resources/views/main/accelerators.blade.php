...
<div class="netmi-subdesc" >Use our unique accelerator system to increase daily interest and speed up the return of principal. Get various bonuses, and obtain internal NTM tokens, which you can sell later to receive even more profit.</div>
...
<div class="netmi-home-slider-info box-1">
        ...
        <div class="netmi-home-block netmi-hfs-2" style="border-left: unset;">
            ...
            <div class="netmi-r"><div><span>2 »</span> Allocation of NTM Tokens</div>
            Provision of a certain number of custom NTM tokens. </div>
        <div class="netmi-cls"></div>
        </div>
...
<div class="netmi-inner">
<div class="netmi-title">
<h3>Advantages <span>of the NTM</span></h3>
            ...
            <div class="sides">
                <div class="l" >
                    <div class="question">
                        ...
                        <div class="answer">Accelerators are unique financial instruments of our company, which give each client the opportunity to increase the return on investment, receive various bonuses, and participate in the placement of an internal NTM token.</div>
                    </div>
                    <div class="question">
...
<br/>
<br/>
Allocation: <b>500 NTM (~ 105$ at the rate of 1NTM = 0.21$)</b><br/>
...
<br/>
Immediately after the purchase, you receive <b>100 NTM</b> to a special locked account.
...
Also, immediately after activation, your <b>500 NTM</b> tokens will be available for sale.
When you sell your tokens in the amount of <b>500 NTM</b>, you will receive up to <b>$105</b> at the rate of <b>0.21$ for 1 NTM</b>. As a result, you will return the funds you spent on the accelerator and make a profit.
<br/>
<br/>
Even if you don't activate the accelerator, it has an expiration date, after which the NTM tokens will still be unlocked and become available for sale. You can activate the accelerator yourself or give it to another participant. In this case you will receive earnings from the sale of your tokens, and the other participant will receive all the other bonuses.</div>
                    </div>
                    <div class="question">
                ...
                <div class="question">
                    ...
                    <div class="question">
                        <h5 ><span class="flaticon-sign-help icon" ></span><span>How do I sell NTM tokens?</span></h5>
...
If you activate the accelerator yourself, you will receive all bonuses owing to you, and your NTM tokens will be unlocked. If the accelerator expires and it has not been activated, the bonuses will be invalid. Nevertheless, the tokens will be unlocked and become available for sale.</div>
                    </div>
                    <div class="question">
