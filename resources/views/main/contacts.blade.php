...
<p class="netmi-contacts-big">{{siteName()}} Limited keeps developing business relationship all over the world.</p>
...
<i class="flaticon-email" style="position:relative; top:3px;  color: #aa72ce; margin-right:5px;"></i> <a href="mailto:info@netmi.org" target="_blank" style="color: #9093ab;">info@{{siteName()}}.org</a></div>
<div><i class="flaticon-soc-tg" style="position:relative; top:3px;  color: #2c9bc0; margin-right:5px;"></i> <a href="http://t.me/netmi_support" target="_blank" style="color: #9093ab;">@{{siteName()}}_support</a></div>
<h6>Branch office</h6>
...
<form action="{{asset('')}}contact" method="POST" autocomplete="off" class="netmi-contacts-form">
