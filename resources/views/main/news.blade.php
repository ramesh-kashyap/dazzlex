...
<main class="netmi-content">
    <div class="netmi-header-page news">
        <div class="netmi-inner">
            <ul class="netmi-breadcrumbs">
                <li class="netmi-breadcrumbs__item"><a href="index.html">Home</a></li>
                <li class="netmi-breadcrumbs__item netmi-breadcrumbs__item--active">News</li>
            </ul>
        </div>
    </div>
    <div class="netmi-static netmi-news">
        <div class="netmi-inner">
            <h1>News</h1>
            <div class="netmi-news-page">
                <div class="netmi-post-list">
                    <div class="netmi-post">
                        <a href="#" onclick="popup_open('#271'); return false;" class="netmi-post__img">
                            <img src="{{ asset('') }}assets/upload/netmi-news-1.jpg " alt="">
                        </a>
                        <div class="netmi-post__content">
                            ...
                            <div class="netmi-post__meta">
                                ...
                                <a href="https://t.me/netmi_news/31" target="_blank" class="netmi-post__category"><span
                ...
                <div class="netmi-post-list">
                    <div class="netmi-post">
                        <a href="#" onclick="popup_open('#269'); return false;" class="netmi-post__img">
                            <img src="{{ asset('') }}assets/upload/netmi-300-days.jpg" alt="">
                        </a>
                        <div class="netmi-post__content">
                            <h3 class="netmi-post__title"><a href="#"
                                    onclick="popup_open('#269'); return false;">Celebrating 300 days online</a></h3>
                            <div class="netmi-post__meta">
                                <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path
                ...
                <div class="netmi-post-list">
                    <div class="netmi-post">
                        <a href="#" onclick="popup_open('#266'); return false;" class="netmi-post__img">
                            <img src="{{ asset('') }}assets/upload/netmi-staking-promo.jpg" alt="">
                        </a>
                        <div class="netmi-post__content">
                            <h3 class="netmi-post__title"><a href="#" onclick="popup_open('#266'); return false;">Promo
                                    staking cycle completed!</a></h3>
                            <div class="netmi-post__meta">
                                <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path
                                ...
                                <a href="https://t.me/netmi_news/23" target="_blank" class="netmi-post__category"><span
                                        class="flaticon-soc-tg netmi-tg netmi-eas"></span> TELEGRAM</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="netmi-post-list">
                    <div class="netmi-post">
                        <a href="#" onclick="popup_open('#263'); return false;" class="netmi-post__img">
                            <img src="{{ asset('') }}assets/upload/netmi-news-2.png" alt="">
                        </a>
                        <div class="netmi-post__content">
                            <h3 class="netmi-post__title"><a href="#" onclick="popup_open('#263'); return false;">New
                                    PDF presentation in now ready</a></h3>
                            <div class="netmi-post__meta">
                                <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path
                                ...
                                <a href="https://t.me/netmi_news/22" target="_blank" class="netmi-post__category"><span
                                        class="flaticon-soc-tg netmi-tg netmi-eas"></span> TELEGRAM</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="netmi-post-list">
                    <div class="netmi-post">
                        <a href="#" onclick="popup_open('#260'); return false;" class="netmi-post__img">
                            <img src="{{ asset('') }}assets/upload/netmi-news-3.jpg" alt="">
                        </a>
                        <div class="netmi-post__content">
                            <h3 class="netmi-post__title"><a href="#" onclick="popup_open('#260'); return false;">New
                                    telegram stickers added</a></h3>
                            <div class="netmi-post__meta">
                                <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path
                                ...
                                <a href="https://t.me/netmi_news/21" target="_blank" class="netmi-post__category"><span
                                        class="flaticon-soc-tg netmi-tg netmi-eas"></span> TELEGRAM</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="netmi-post-list">
                    <div class="netmi-post">
                        <a href="#" onclick="popup_open('#257'); return false;" class="netmi-post__img">
                            <img src="{{ asset('') }}assets/upload/netmi-news-4-1.jpg" alt="">
                        </a>
                        <div class="netmi-post__content">
                            <h3 class="netmi-post__title"><a href="#" onclick="popup_open('#257'); return false;">New
                                    dynamic marketing plans</a></h3>
                            <div class="netmi-post__meta">
                                <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path
                                ...
                                <a href="https://t.me/netmi_news/20" target="_blank" class="netmi-post__category"><span
                                        class="flaticon-soc-tg netmi-tg netmi-eas"></span> TELEGRAM</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="netmi-post-list">
                    <div class="netmi-post">
                        <a href="#" onclick="popup_open('#252'); return false;" class="netmi-post__img">
                            <img src="{{ asset('') }}assets/upload/netmi-pdf.jpg" alt="">
                        </a>
                        <div class="netmi-post__content">
                            <h3 class="netmi-post__title"><a href="#"
                                    onclick="popup_open('#252'); return false;">Introducing Netmi Accelerators!</a></h3>
                            <div class="netmi-post__meta">
                                <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path
                                ...
                                <a href="https://t.me/netmi_news/13" target="_blank" class="netmi-post__category"><span
                                        class="flaticon-soc-tg netmi-tg netmi-eas"></span> TELEGRAM</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="netmi-post-list">
                    <div class="netmi-post">
                        <a href="#" onclick="popup_open('#250'); return false;" class="netmi-post__img">
                            <img src="{{ asset('') }}assets/upload/netmi-staking-promo.jpg" alt="">
                        </a>
                        <div class="netmi-post__content">
                            <h3 class="netmi-post__title"><a href="#" onclick="popup_open('#250'); return false;">First
                                    week online progress report</a></h3>
                            <div class="netmi-post__meta">
                                <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path
                                ...
                                <a href="https://t.me/netmi_news/8" target="_blank" class="netmi-post__category"><span
                                        class="flaticon-soc-tg netmi-tg netmi-eas"></span> TELEGRAM</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="netmi-post-list">
                    <div class="netmi-post">
                        <a href="#" onclick="popup_open('#248'); return false;" class="netmi-post__img">
                        ...
                        <div class="netmi-post__content">
                            ...
                            <div class="netmi-post__meta">
                                ...
                                <a href="https://t.me/netmi_news/4" target="_blank" class="netmi-post__category"><span
                                        class="flaticon-soc-tg netmi-tg netmi-eas"></span> TELEGRAM</a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="popup" id="271">
        <div class="popup-container" style="transform: translate(0%, 0%);">
            <div class="in">
                ...
                <p style="margin-bottom: 15px;">Recently, our company has celebrated the first anniversary of stable
                    online operations! We sincerely thank everyone who has been with us and supported us<span
                        class="Apple-converted-space">&nbsp; </span>in this venture! During this year, we have fulfilled
                ...
                <p style="margin-bottom: 15px;"><span style="color: #aa72ce;"><strong>-</strong></span>
                    <strong>Accelerators can now be applied to an active deposits. It will allow you to raise your daily
                        income, get additional bonuses and tokens.</strong></p>
                <p style="margin-bottom: 15px;"><span style="color: #aa72ce;"><strong>-</strong></span> <strong>Tokens
                        that are credited after the purchase of accelerators will be blocked for 30 days, regardless of
    ...
    <div class="popup" id="269">
        <div class="popup-container" style="transform: translate(0%, 0%);">
            <div class="in">
                <div class="close" onclick="popup_close('#269');"><span class="flaticon-close"></span></div>
                <h4 style="margin-top: 0px; padding-right: 40px">Celebrating 300 days online</h4>
                <div class="netmi-post__meta"
                    style="border-bottom: 1px dashed #2f3349; padding-bottom: 10px;margin-bottom: 20px; height: 40px;">
                    <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
                ...
                <p style="margin-bottom: 15px;">Moreover, after reaching the targeted number of holders and sufficient
                    ...
                    exchanges.</p>
                <p style="margin-bottom: 15px;">Stay tuned and follow the news!<span
                        class="Apple-converted-space">&nbsp;</span></p>
                <p style="margin-bottom: 15px;"><strong>Today we celebrate <span style="color: #aa72ce;">300 days</span>
                        of stable operation of our platform!</strong>&nbsp;</p>
                <p style="margin-bottom: 15px;">Let us thank all of you who have joined and accompanied us in this
                    journey!</p>
                <p style="margin-bottom: 15px;">Thank you for your trust and support! Let's strive for new heights
                    together!</p>
            </div>
        </div>
        <div class="popup-overlay"></div>
    </div>
    <div class="popup" id="266">
        <div class="popup-container" style="transform: translate(0%, 0%);">
            <div class="in">
                <div class="close" onclick="popup_close('#266');"><span class="flaticon-close"></span></div>
                <h4 style="margin-top: 0px; padding-right: 40px">Promo staking cycle completed!</h4>
                <div class="netmi-post__meta"
                    style="border-bottom: 1px dashed #2f3349; padding-bottom: 10px;margin-bottom: 20px; height: 40px;">
                    <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
                ...
                <p style="margin-bottom: 15px;">Dear friends,</p>
                <p style="margin-bottom: 15px;">We have just successfully completed our promotional investment cycle
                    with increased ROI and paid out interest and principal to those of you who have taken this
                    opportunity and joined us in this venture. Congratulations! Many thanks for your kind support and
                    cooperation!</p>
    ...
    <div class="popup" id="263">
        <div class="popup-container" style="transform: translate(0%, 0%);">
            <div class="in">
                <div class="close" onclick="popup_close('#263');"><span class="flaticon-close"></span></div>
                <h4 style="margin-top: 0px; padding-right: 40px">New PDF presentation in now ready</h4>
                <div class="netmi-post__meta"
                    style="border-bottom: 1px dashed #2f3349; padding-bottom: 10px;margin-bottom: 20px; height: 40px;">
                    <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
                ...
                <p style="margin-bottom: 15px;">In order to help you to understand our business model better we have
                ...
                <p style="margin-bottom: 15px;">We are working hard to develop our platform to provide you with the best
                    investment experience!<span class="Apple-converted-space">&nbsp;</span></p>
                <p>Let's work and prosper together!</p>
            </div>
        </div>
        <div class="popup-overlay"></div>
    </div>
    <div class="popup" id="260">
        <div class="popup-container" style="transform: translate(0%, 0%);">
            <div class="in">
                <div class="close" onclick="popup_close('#260');"><span class="flaticon-close"></span></div>
                <h4 style="margin-top: 0px; padding-right: 40px">New telegram stickers added</h4>
                <div class="netmi-post__meta"
                    style="border-bottom: 1px dashed #2f3349; padding-bottom: 10px;margin-bottom: 20px; height: 40px;">
                    <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
                ...
                <p style="margin-bottom: 15px;">Dear members,</p>
                <p>We have just added a new telegram sticker collection. Feel free to use it to express yourself in our
                    chat, and promote us in other telegram venues!</p>
            </div>
        </div>
        <div class="popup-overlay"></div>
    </div>
    <div class="popup" id="257">
        <div class="popup-container" style="transform: translate(0%, 0%);">
            <div class="in">
                <div class="close" onclick="popup_close('#257');"><span class="flaticon-close"></span></div>
                <h4 style="margin-top: 0px; padding-right: 40px">New dynamic marketing plans</h4>
                <div class="netmi-post__meta"
                    style="border-bottom: 1px dashed #2f3349; padding-bottom: 10px;margin-bottom: 20px; height: 40px;">
                    <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
                ...
                <p style="margin-bottom: 15px;">Our investment team has gained lots of experience, we have experimented
                    ...
                    deal of profit during this amazing crypto bullrun season. Now we think it is right time to share the
                    fruits and benefits of our work with our valued partners.</p>
                ...
                <p style="margin-bottom: 15px;">All current deposits will be transferred to the new Staking plans and
                    continue to receive daily profits as per usual.</p>
                <p style="margin-bottom: 15px;">We have also increased the level of our Affiliate rewards</p>
                <p style="margin-bottom: 15px;">up to 10% for direct referrals at RUBY partner status.</p>
                <p>We are starting our full scale advertising and promotion campaign and invite all interested parties
                    to join in, make profits and share our success!</p>
            </div>
        </div>
        <div class="popup-overlay"></div>
    </div>
    <div class="popup" id="252">
        <div class="popup-container" style="transform: translate(0%, 0%);">
            <div class="in">
    ...
    <div class="popup" id="250">
        <div class="popup-container" style="transform: translate(0%, 0%);">
            <div class="in">
                <div class="close" onclick="popup_close('#250');"><span class="flaticon-close"></span></div>
                <h4 style="margin-top: 0px; padding-right: 40px">First week online progress report</h4>
                <div class="netmi-post__meta"
                    style="border-bottom: 1px dashed #2f3349; padding-bottom: 10px;margin-bottom: 20px; height: 40px;">
                    <span class="netmi-post__date"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
                ...
                <p style="margin-bottom: 15px;">The platform shows excellent performance, our custom developed software
                    accepts funds and pays investment returns in strict accordance with the established schedules. The
                    support service promptly responds to user's requests and helps to resolve emerging issues. The
                    advertising campaign is underway and gaining momentum.</p>
                <p style="margin-bottom: 15px;">All funds that we receive from investors are assigned to our trading
                ...
                <p style="margin-bottom: 15px;">Don't be left behind as it is only the beginning and we are in for a
                    good long ride!</p>
                <p>Let's rock and prosper together!</p>
            </div>
        </div>
        <div class="popup-overlay"></div>
    </div>
    <div class="popup" id="248">
        <div class="popup-container" style="transform: translate(0%, 0%);">
            <div class="in">
                ...
                <p style="margin-bottom: 15px;">The project features a one-of-a-kind marketing and investment concept
                    ...
                    participating.</p>
                <p style="margin-bottom: 15px;">Our investment analysts are constantly trying to reduce risk and
                    increase profitability. The marketing staff is working to get the news out about us. All payment
                    gateways are operational and fully equipped to handle any workload. Our support staff is available
                    24 hours a day, 7 days a week to fix your problems and answer your inquiries.</p>
                <p style="margin-bottom: 15px;">All in all we have everything set up to have an extraordinary long haul
                    opportunity going and invite everybody to participate, contribute and create wealth with us!</p>
                <p style="margin-bottom: 15px;">Apparently we are in for a great and productive time together!<br /> You
                    are heartily welcomed! Let's get started!</p>
                <p>Please, keep tuned and subscribe to our telegram channel to stay up to date with current program news
                    and developments!</p>
            </div>
        </div>
        <div class="popup-overlay"></div>
