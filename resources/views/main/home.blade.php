                    ...
                    <div class="bxhead-info">
                        ...
                        <div class="netmi-header-trustpilot">
                            <a target="_blank" href="https://www.trustpilot.com/review/netmi.org">
                                <div>Trustpilot</div>
                                <div>
                                    <img src="{{asset('')}}assets/tpl/images/trustpilot-5-stars.svg?v=3.10.1726217824"
                                        alt="">
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="fixhead-img"><img
                            src="{{asset('')}}assets/tpl/images/header-bitcoin-ne7a1a.png?v=3.10.1726217824" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="netmi-main">
                <div class="netmi-features">
                    <div class="netmi-inner">
                        ...
                        <div class="gw-header boost-header">
                            <div class="container gw-header-body">
                                ...
                                <div class="gw-contest-col">
                                    <div class="gw-contest boost-contest">
                                        <div class="gw-contest__img">
                                            <img src="{{asset('')}}assets/tpl/images/home/home-token-ntm7a1a.png?v=3.10.1726217824"
                                                alt="NTM">
                                        </div>
                                        ...
                                        <div class="gw-contest__foot">
                                            <div class="gw-contest__bank">
                                                <strong>+0.5%</strong>
                                            </div>
                                            <div class="gw-contest__i">
                                                <p
                                                    data-tippy-content="Подробнее о системе скидок и бустере вы можете узнать в разделе FAQ на Geekchange.">
                                    ...
                                    <div class="coin-specs__head__box__data__row">
                                        <div class="coin-specs__head__box__data__col">
                                            <div class="coin-specs__head__box__data__box ">
                                                <div class="coin-specs__head__box__data__box__text">Increased
                                                    Profitability</div>
                                            ...
                                            <div class="coin-specs__head__box__data__box ">
                                                <div class="coin-specs__head__box__data__box__text">Cashback to the Main
                                                    balance</div>
                                                <div class="coin-specs__head__box__data__box__data__blue"><img
                                                        src="{{asset('')}}assets/tpl/images/home/accelerator-check7a1a.svg"
                                                        alt=""></div>
                                        ...
                                        <div class="coin-specs__head__box__data__col">
                                            <div class="coin-specs__head__box__data__box ">
                                                <div class="coin-specs__head__box__data__box__text">Bonus to Premium
                                                    balance</div>
                                                <div class="coin-specs__head__box__data__box__data__green"><img
                                                        src="{{asset('')}}assets/tpl/images/home/accelerator-check7a1a.svg"
                                                        alt=""></div>
                                            </div>
                                            <div class="coin-specs__head__box__data__box">
                                                <div class="coin-specs__head__box__data__box__text ">Stake Amount Bonus
                                                    (%)</div>
                                                <div class="coin-specs__head__box__data__box__data__green"><img
                                                        src="{{asset('')}}assets/tpl/images/home/accelerator-check7a1a.svg"
                                                        alt=""></div>
                                            ...
                                            <div class="coin-specs__head__box__data__box">
                                                <div class="coin-specs__head__box__data__box__text ">Bonus to the stake
                                                    amount ($)</div>
                                                <div class="coin-specs__head__box__data__box__data__green"><img
                                                        src="{{asset('')}}assets/tpl/images/home/accelerator-check7a1a.svg"
                                                        alt=""></div>
                                                ...
                                                <div class="col-12-new col-lg-5-new">
                                                    <div class="invest__rate-wrap-new">
                                                        ...
                                                        <div class="invest__graph-new">
                                                            <img src="{{asset('')}}assets/tpl/images/icons/graph17a1a.svg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12-new col-lg-5-new offset-lg-1-new">
                                                    <div class="invest__rate-wrap-new">
                                                        <div class="invest__rate-new">
                                                            ...
                                                            <p class="purple">+0.49%</p>
                                                        </div>

                                                        <div class="invest__graph-new">
                                                            <img src="{{asset('')}}assets/tpl/images/icons/graph27a1a.svg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12-new col-lg-5-new">
                                                    <div class="invest__rate-wrap-new">
                                                        <div class="invest__rate-new">
                                                            ...
                                                            <p class="purple">+4.62%</p>
                                                        </div>

                                                        <div class="invest__graph-new">
                                                            <img src="{{asset('')}}assets/tpl/images/icons/graph37a1a.svg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12-new col-lg-5-new offset-lg-1-new">
                                                    <div class="invest__rate-wrap-new">
                                                        <div class="invest__rate-new">
                                                            ...
                                                            <p class="purple">+564.44%</p>
                                                        </div>

                                                        <div class="invest__graph-new">
                                                            <img src="{{asset('')}}assets/tpl/images/icons/graph47a1a.svg"
                                                                alt="">
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="netmi-title">
                            <h3>Statistics</h3>
                            <div class="netmi-d">Live updated platform performance. Witness our growth and success in
                                real time.</div>
                        </div>
                        <div class="netmi-features-stat">
                            <div class="netmi-item netmi-bloc-1">
                                <div class="netmi-icon"><img src="{{asset('')}}assets/tpl/images/home/stat-17a1a.svg"
                                        alt=""></div>
                                <div class="netmi-number"><span>176 762</span></div>
                                <div class="netmi-desc">Active Members</div>
                            </div>
                            <div class="netmi-item netmi-bloc-2">
                                <div class="netmi-icon"><img src="{{asset('')}}assets/tpl/images/home/stat-27a1a.svg"
                                        alt=""></div>
                            ...
                            <div class="netmi-item netmi-bloc-3">
                                <div class="netmi-icon"><img src="{{asset('')}}assets/tpl/images/home/stat-37a1a.svg"
                                        alt=""></div>
                            ...
                            <div class="netmi-item netmi-bloc-4">
                                <div class="netmi-icon"><img src="{{asset('')}}assets/tpl/images/home/stat-47a1a.svg"
                                        alt=""></div>
                        ...
                        <div class="netmi-desc">
                            ...
                            <div class="netmi-textbox">
                                <p>Netmi is a virtual ecosystem that makes crypto investments available to general
                                    ...
                                    guidance you don't need to have a degree in finance, special trading or programming
                                    skills. It is sufficient to register, choose an investment plan, add funds to your
                                    account balance, make some stakes, and the profits will start rolling in.</p>
                            </div>
                ...
                <div class="netmi-inner">
                    ...
                    <div class="netmi-home-slider-info">
                        <div class="netmi-home-block netmi-hfs-1">
                            <div class="netmi-l"><img src="{{asset('')}}assets/tpl/images/home/advantages-17a1a.svg"
                                    alt=""></div>
                            <div class="netmi-r">
                                <div><span>1 »</span>
                                    <a href="#" onclick="popup_open('#popup-signup'); return false;">Free to join</a>
                                </div>
                                Create your account with several clicks.
                            </div>
                            <div class="netmi-cls"></div>
                        </div>
                        <div class="netmi-home-block netmi-hfs-2">
                            <div class="netmi-l"><img src="{{asset('')}}assets/tpl/images/home/advantages-27a1a.svg"
                                    alt=""></div>
                            <div class="netmi-r">
                                <div><span>2 »</span> Easy to top up</div>
                                Add funds to your account with your favorite crypto.
                            </div>
                            <div class="netmi-cls"></div>
                        </div>
                        <div class="netmi-home-block netmi-hfs-3">
                            <div class="netmi-l"><img src="{{asset('')}}assets/tpl/images/home/advantages-37a1a.svg"
                                    alt=""></div>
                            <div class="netmi-r">
                                <div><span>3 »</span> Simple to start</div>
                                Build multiple income streams from staking and rewards.
                            </div>
                            <div class="netmi-cls"></div>
                        </div>
                        <div class="netmi-cls"></div>
