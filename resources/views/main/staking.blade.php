...
<div class="netmi-subdesc" >Allocate your free crypto assets to our trading pool, provide liquidity for {{siteName()}} custom developed crypto instruments, and get paid generous returns on a daily basis.</div>
            ...
            <div class="sides">
                <div class="l" >
                    <div class="question">
                        ...
                        <div class="answer">Top up your member account, choose from the Staking options available, and allocate your free crypto assets to {{siteName()}} trading pool.</div>
                    </div>
                    <div class="question">
