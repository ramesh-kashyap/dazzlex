...
<main class="eas bg-gray">
   ...
   <div class="container">
    ...
    <!-- <a href="{{route('user.invest')}}"  style="outline: none;" >
       ...
       <a href="{{route('user.fundHistory')}}" style="outline: none;" >
        <strong>
            Fund History     
        </strong></a>
...
@foreach($level_income as $value)
                    ...
                    <td class="td-price">
                        ...
                        <td class="td-price">
                        <div>
                            <span class="amount-dark">{{$value->txn_no}}</span>
                        </div></td>
                        <td class="td-price">
                        <div>
                            <span class="amount-dark">{{date("D, d M Y h:i:s a", strtotime($value->created_at));}} </span>
                        </div></td>
                        <!-- <td class="td-price">
                        <div>
