                            ...
                            <div class="account-form account-form--2">
                                ...
                                <div class="g">
                                    <div class="g-left">
                                        ...
                                        <div class="xsel xsel--0">
                                            <div class="SumoSelect sumo_network_id" tabindex="0" role="button"
                                                aria-expanded="false">
                                                <select id="paymentModeSelect" class="inp inp-0 input-only-pos"
                                                    name="paymentMode">
                                    ...
                                    <div class="g-right g-currency">
                                        ...
                                        <input type="text" class="inp inp-0 input-only-pos" placeholder="Enter Amount"
                                            data-init="0" name="amount">
                                    </div>
                                ...
                                <div class="table-row clearfix">
                                    ...
                                    <div class="reviews-item deposits-balance"
                                        ...
                                        <div class="head balance-left active">
                                            <img src="{{ asset('') }}assets/theme/images/netmi/main-wallet-3.svg?v=3.22.1726217824"
                                                alt="">
                ...
                <div class="date">Premium balance</div>
                                ...
                                <div class="b b--1">
                                    <button type="submit" class="btn btn-b"
                                        style="outline: none; color:#fff; text-decoration: none"
                        ...
                        <div class="account-tab tab-active ">
                            <div class="account-info-list">
                                <div class="account-form account-form--2">
                                    ...
                                    <div class="account-no-data"><i class="flaticon-info icon"></i><br>No active
                                        stakes<br><a class="btn btn-affiliate"
                                            style="width: max-content; margin: 30px auto 0px; outline: none;"
                                            href="/deposits#new">New stake</a></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="account-tab tab-reinvest ">
                            ...
                            <div class="account-info-list">
                                <div class="account-form account-form--2">
                                    ...
                                    <div class="account-no-data"><i class="flaticon-info icon"></i><br>You have no
                                        reinvestment offer<br><a class="btn btn-affiliate"
                                            style="width: max-content; margin: 0px auto; padding: 0px 20px;margin-top: 20px;"
                                            href="/deposits#new">Новый депозит</a>.</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="account-tab tab-previous ">
                            <div class="account-info-list">
                                <div class="account-form account-form--2">
                                    ...
                                    <div class="account-no-data"><i class="flaticon-info icon"></i><br>No expired
                                        stakes<br><a class="btn btn-affiliate"
                                            style="width: max-content; margin: 30px auto 0px; outline: none;"
                                            href="/deposits#new">New stake</a></div>
                                </div>
...
<script>
    document.getElementById('paymentModeSelect').addEventListener('change', function () {
        ...
        var finalAmountElement = document.querySelector(
        '.final-deposit-amount'); // Target the final deposit amount div
