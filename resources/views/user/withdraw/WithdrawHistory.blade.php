...
<div id="example_wrapper" class="dataTables_wrapper">
                                    <form action="{{ route('user.WithdrawHistory') }}" method="GET">
                                        <div class="row">
                                            <div class="col-xl-4">
...
<div class="account-tab tab-topup active">
        ...
        <div class="caption caption--border" style="padding-bottom: 0px;"> Withdraw History </div>
...
@foreach($withdraw_report as $value)
                    ...
                    <td class="td-price">
                        <div>
                            <span class="amount-dark">{{currency()}} {{ ($value->amount) }}</span>
                        </div></td>
                        <td class="td-price">
                        <div>
                        ...
                        <td class="td-price">
                        <div>
                            <span class="amount-dark">{{ $value->txn_id }}</span>
                        </div></td>
