...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany('App\Models\Income','user_id','id')->where('remarks','Rank Reward');
    } 
    ...
    {
        return $this->hasMany('App\Models\Income','user_id','id')->where('remarks','Comapny Reward');
    } 
