...
public function BankDetail()
    ...
    public function profile_update(Request $request)
    {
        try{
          ...
          $update_data['townCity']=$post_array['townCity'];
        //   $update_data['pinCode']=$post_array['pinCode'];
        //   $update_data['trx_addres']=$post_array['trx_addres'];
        //   $update_data['usdBep20']=$post_array['usdBep20'];
        //   $update_data['usdArbitrum']=$post_array['usdArbitrum'];
    ...
    public function profile_wallet(Request $request)
    {
        try{
            $validation =  Validator::make($request->all(), [
                'usdBep20' => 'required',
